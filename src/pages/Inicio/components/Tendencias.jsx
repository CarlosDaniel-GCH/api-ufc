        ...
        <section className="w-full h-auto mt-12">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-2 w-full h-70 px-2">
                <a 
                    ...
                    className="w-full"
                >
                    <div className="contenedor-tendencias ct-1 text-white w-full h-[300px] px-4 py-0 flex justify-center items-center flex-col relative overflow-hidden bg-cover bg-center cursor-pointer">
                        <h2 className="absolute top-[130px] text-base font-bold">TOPURIA SUBE A PESO LIGERO</h2>
                    </div>
                </a>
                <a 
                    ...
                    className="w-full"
                >
                    <div className="contenedor-tendencias ct-2 text-white w-full h-[300px] px-4 py-0 flex justify-center items-center flex-col relative overflow-hidden bg-cover bg-center cursor-pointer">
                        <h2 className="absolute top-[130px] text-base font-bold">PEREIRA BUSCA REVANCHA</h2>
                    </div>
                </a>
                <a 
                    ...
                    className="w-full"
                >
                    <div className="contenedor-tendencias ct-3 text-white w-full h-[300px] px-4 py-0 flex justify-center items-center flex-col relative overflow-hidden bg-cover bg-center cursor-pointer">
                        <h2 className="absolute top-[120px] text-base font-bold">UFC 5 TRAE EL REALISMO AL OCTÁGONO</h2>
                    </div>
                </a>
                <a 
                    ...
                    className="w-full"
                >
                    <div className="contenedor-tendencias ct-4 text-white w-full h-[300px] px-4 py-0 flex justify-center items-center flex-col relative overflow-hidden bg-cover bg-center cursor-pointer">
                        <h2 className="absolute top-[130px] text-base font-bold">EL REGRESO DE AMANDA NUNES</h2>
                    </div>
                </a>
            </div>
